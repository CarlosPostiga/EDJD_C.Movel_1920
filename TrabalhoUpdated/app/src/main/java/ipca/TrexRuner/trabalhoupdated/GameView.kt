...
class GameView: SurfaceView, Runnable {
    ...
    private fun startActivityDead() { // TODO Auto-generated method stub

        val intent= Intent(getContext(), DeadActivity::class.java)
        context.startActivity(intent)
